// Sidebar navigation groups for the docs site.
// `path` is relative to the docs root ("/").
export const NAV_GROUPS = [
  {
    title: "Getting Started",
    items: [
      { label: "Introduction", path: "/" },
      { label: "Theming & Tokens", path: "/theming" },
  ...
  {
    title: "Layout",
    items: [{ label: "App Shell", path: "/components/layout" }],
  },
];
